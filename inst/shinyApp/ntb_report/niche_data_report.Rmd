...
```{r ,eval=printKmeansPlot,echo=printKmeansPlot,webgl=TRUE}
...
corre_mat_lower <- lower.tri(corr_table(), diag = FALSE)
corre_mat <- corr_table()[corre_mat]
...
if(!is.null(corr_table())){
  corre_mat_lower <- lower.tri(corr_table(), diag = FALSE)
  corre_mat <- corr_table()[corre_mat_lower]
